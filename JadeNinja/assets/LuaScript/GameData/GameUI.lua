...
elseif (IS_PLATFORM_ANDROID) then
	UI_FULLSCREEN_HEIGHT = 270 * APP_SCALE_FACTOR;
else
...
elseif IS_PLATFORM_ANDROID then
	UI_MAP_LEVEL_ORIGIN = { (SCREEN_UNIT_X - UI_MAP_LEVEL_SIZE[1]) * 0.5 / APP_UNIT_X, 110 * APP_SCALE_FACTOR / APP_UNIT_Y };
else
...
elseif IS_PLATFORM_ANDROID then
	UI_SCROLL_SIZE = { 237 * APP_SCALE_FACTOR, 59 * APP_SCALE_FACTOR };
	UI_SCROLL_COIN_OFFSET = { 80, 33 };
	UI_SCROLL_ASSIGN_POS = { 69 * APP_SCALE_FACTOR, 33 * APP_SCALE_FACTOR };
	UI_SCROLL_UNLOCK_POS = { 58 * APP_SCALE_FACTOR, 30 * APP_SCALE_FACTOR };
	UI_SCROLL_MASTER = 152 * APP_SCALE_FACTOR;
else
